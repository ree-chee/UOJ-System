	...
	<section>
		...
		<div class="card my-1">
			...
			<div id="collapseThree" class="collapse">
				<div class="card-body">
					<p>默认的测评环境是 Ubuntu Linux 22.04 LTS x64。</p>
					<p>C的编译器是 gcc 11.3.0，编译命令：<code>gcc code.c -o code -lm -O2 -DONLINE_JUDGE</code>。</p>
					<p>C++的编译器是 g++ 11.3.0，编译命令：<code>g++ code.cpp -std=c++14 -o code -lm -O2 -DONLINE_JUDGE</code>。如果选择C++XX会修改参数<code>-std=c++14</code>至<code>-std=c++XX</code>。</p>
